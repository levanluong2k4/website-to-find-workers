              ...
              <section class="dispatch-panel dispatch-plain-card">
                <div style="display:flex; gap:14px; align-items:flex-start;">
                  ...
                  <div>
                    ...
                    <div class="dispatch-muted-copy" style="margin-top:8px;">Các đơn qua hệ thống được ghi nhận và lưu vết thao tác để hỗ trợ xử lý bảo hành hoặc phát sinh kỹ thuật.</div>
                  </div>
                </div>
              </section>
            </aside>
