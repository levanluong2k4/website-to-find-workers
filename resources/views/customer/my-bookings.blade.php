...
@push('scripts')
<script type="module" src="{{ asset('assets/js/customer/my-bookings.js') }}?v={{ file_exists(public_path('assets/js/customer/my-bookings.js')) ? filemtime(public_path('assets/js/customer/my-bookings.js')) : time() }}"></script>
@endpush
