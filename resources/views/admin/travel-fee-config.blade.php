...
<style>
  ...
  /* status chip tones */
  .tfc-status-chip[data-tone="success"] {
    background: #dcfce7;
    color: #166534;
  }

  .tfc-status-chip[data-tone="danger"] {
    background: #fee2e2;
    color: #991b1b;
  }

  .tfc-status-chip[data-tone="info"] {
    background: #dbeafe;
    color: #1e40af;
  }

  /* tier table */
  .tfc-tier-row-invalid input {
        ...
        <div class="lg:tw-col-span-8 tw-space-y-8">
          ...
          <div class="tw-bg-surface-container-lowest tw-p-8 tw-rounded-3xl tw-shadow-sm">
            ...
            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-6">
              ...
              <div class="tw-space-y-2">
                <label class="tw-text-[10px] tw-font-bold tw-uppercase tw-tracking-widest tw-text-slate-500">Thời hạn bảo hành (Ngày)</label>
                <div class="tw-relative group">
