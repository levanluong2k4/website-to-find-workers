...
<style>
    ...
    .adm-kpi-2 .adm-kpi-ic {
        background: #e0f2fe;
        color: #0369a1;
    }

    .adm-kpi-3 .adm-kpi-ic {
        background: #f0fdf4;
        color: #15803d;
    }

    .adm-kpi-4 .adm-kpi-ic {
        background: #fef2f2;
        color: #b91c1c;
    }
...
<div class="container-fluid py-4" style="max-width: 1600px; margin: 0 auto;">
    <main class="adm-main" id="adminDashboard">
        ...
        <section class="adm-kpis">
            <article class="adm-kpi adm-kpi-1">
                <div class="adm-kpi-top">
                    <div class="adm-kpi-ic"><i class="fa-solid fa-money-bill-wave"></i></div><span class="adm-pill tone-positive" id="summaryRevenueNote">+0%</span>
                </div><small>Doanh thu hôm nay</small><strong id="summaryRevenueToday">0 đ</strong>
            </article>
            <article class="adm-kpi adm-kpi-2">
                <div class="adm-kpi-top">
                    <div class="adm-kpi-ic"><i class="fa-regular fa-calendar"></i></div><span class="adm-pill tone-muted" id="summaryBookingsNote">Stable</span>
                </div><small>Đơn đặt lịch hôm nay</small><strong id="summaryBookingsToday">0</strong>
            </article>
            <article class="adm-kpi adm-kpi-3">
                <div class="adm-kpi-top">
                    <div class="adm-kpi-ic"><i class="fa-solid fa-building-columns"></i></div><span class="adm-pill tone-positive" id="summaryCommissionNote">+0%</span>
                </div><small>Hoa hồng hệ thống</small><strong id="summaryCommission">0 đ</strong>
            </article>
            <article class="adm-kpi adm-kpi-4">
                <div class="adm-kpi-top">
                    <div class="adm-kpi-ic"><i class="fa-regular fa-flag"></i></div><span class="adm-pill tone-danger" id="summaryComplaintsNote">0</span>
                </div><small>bảo hành mới</small><strong id="summaryComplaints">0</strong>
            </article>
        </section>
        ...
        <section class="adm-board">
            <div class="adm-stack">
                ...
                <article class="adm-card">
                    <div class="adm-card-h">
                        <div>
                            <h2>Khối doanh thu theo xu hướng</h2>
                            <p>Thống kê cho <span id="metaPeriodLabel">hôm nay</span></p>
                        </div>
                        <div class="adm-rev-num"><strong id="revenuePeriodTotal">0 đ</strong><span class="tone-positive" id="revenuePeriodNote">0%</span>
                            <div class="adm-meta" id="metaUpdatedAt">Cập nhật --:--</div>
                        </div>
                    </div>
                    <div class="adm-rev">
                        <div class="adm-chart"><svg id="revenueChart" viewBox="0 0 720 268" preserveAspectRatio="none" aria-label="Biểu đồ doanh thu"></svg>
                            <div class="adm-chart-labels" id="revenueChartLabels"></div>
                        </div>
                        <div class="adm-rev-foot">
                            <div class="adm-mini">
                                <div><span class="adm-tt">Top services</span><strong id="revenueTopService">Chưa có dữ liệu</strong>
                                    <div class="adm-line"><span style="width:42%"></span></div>
                                </div>
                                <div><span class="adm-tt">Tỷ trọng chuyển khoản</span><strong id="revenueTransferShare">0% doanh thu</strong>
                                    <div class="adm-line"><span style="width:28%"></span></div>
                                </div>
                            </div>
                ...
                <article class="adm-card">
                    <div class="adm-card-h">
                        <h2>Bảng chi tiết doanh thu</h2><a href="/admin/bookings" class="adm-meta" style="text-decoration:none;color:var(--blue);font-weight:700">Xuất báo cáo</a>
                    </div>
                    <div class="adm-table-wrap">
                        <table class="adm-table">
                            ...
                            <tbody id="revenueTableBody">
                                <tr>
                                    <td colspan="5" class="adm-empty">Đang tải dữ liệu doanh thu...</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <aside class="adm-stack">
                <article class="adm-card adm-side-card">
                    <div class="adm-card-h">
                        <h2>Khối cận xử lý</h2><span class="adm-chip adm-chip-blue">Hôm nay</span>
                    </div>
                    ...
                    <div class="adm-queue" id="bookingQueueList">
                        <div class="adm-queue-item adm-queue-item--info">
                            <h4>Đang tải hàng đợi vận hành...</h4>
                        </div>
                    </div>
                </article>
                ...
                <article class="adm-card adm-side-card">
                    ...
                    <div class="adm-workers">
                        <div class="adm-avatars"><span>A</span><span>D</span><span>M</span><span class="light">+85</span></div>
                        <div><strong><span id="workersTotal">0</span> ThV</strong><small><span id="workersActive">0</span> đang online</small></div>
                    </div>
                    <div class="adm-split">
                        <div class="adm-s"><strong id="workersPending">0</strong><span>Profile chờ duyệt</span></div>
                        <div class="adm-s"><strong id="workersLowRating">0</strong><span>Thợ bị rate thấp</span></div>
                    </div>
                    <div class="adm-side-label">Signals</div>
                    <div class="adm-signals" id="workerWatchList">
                        <div>Đang tải tín hiệu từ đội thợ...</div>
                    </div>
                </article>

                <article class="adm-card adm-side-card">
                    <div class="adm-card-h">
                        <h2>Khối bảo hành/phản ánh</h2>
                    </div>
                    <div class="adm-complaints">
                        <div class="adm-complaint-item adm-complaint-item--danger">
                            <div><strong>bảo hành chưa xử lý</strong>
                                <p>Mức độ ưu tiên: cao</p>
                            </div><span id="complaintsNew">0</span>
                        </div>
                        <div class="adm-complaint-item adm-complaint-item--warning">
                            <div><strong>Đánh giá dưới 3 sao</strong>
                                <p>Theo dõi trong ngày</p>
                            </div><span id="complaintsLowRating">0</span>
                        </div>
                        <div class="adm-complaint-item">
                            <div><strong>Đơn hủy có lý do</strong>
                                <p>Nguy cơ cần kiểm tra</p>
                            </div><span id="complaintsCanceled">0</span>
                        </div>
                    </div>
                    <div class="adm-side-label">Feedback mới nhất</div>
                    <div class="adm-feedback" id="complaintList">
                        <div class="adm-feedback-item"><i></i>
                            <div>
                                <h4>Đang tải phản ánh...</h4>
                                <p>Hệ thống đang tổng hợp phản hồi từ đánh giá và đơn đặt lịch.</p>
                            </div>
                        </div>
                    </div>
                </article>
