...
OUT_PATH = os.path.join(BASE_DIR, "output", "doc", "bao-cao-csdl-5cot-dung-mau.docx")
...
TABLES = [
    {
        ...
        "relation": "Quan hệ: 1-1 với ho_so_tho; 1-n với don_dat_lich (khach_hang_id, tho_id); n-n với danh_muc_dich_vu qua tho_dich_vu."
    },
    {
    ...
    },
    {
        ...
        "relation": "Quan hệ: n-1 với users (khach_hang_id, tho_id); n-n với danh_muc_dich_vu qua don_dat_lich_dich_vu."
    },
    {
...
doc.add_heading('MÔ TẢ CƠ SỞ DỮ LIỆU CÁC BẢNG CHÍNH', level=1)
